...
<body class="whitebackground">
	...
	<div class="content" >
		...
		<li><a href="#" onclick="javascript:getResults(queryObjects);">Get all the objects</a></li>
		<li><a href="#" onclick="javascript:getResults(queryManifestations);">Get all the manifestations</a></li>
		<li><a href="#" onclick="javascript:getResults(queryWorks);">Get all the works, their manifestations and expressions</a></li>
		<li><a href="#" onclick="javascript:getResults(querySameAs);">Get generated links</a></li>
		</ul>
