...
<head>
    ...
    <script type="text/javascript" charset="UTF-8">
		...
		$(function(){
			...
			var queryObjects = "PREFIX rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#> PREFIX ecrm:   <http://erlangen-crm.org/current/> PREFIX efrbroo: <http://erlangen-crm.org/efrbroo/> select ?object ?name where { ?object rdf:type ecrm:E18_Physical_Thing . OPTIONAL {?object ecrm:P1_is_identified_by ?apel. ?apel ecrm:P3_has_note ?name }}";
