...
INSERT INTO `xml_tag` (`xml_tag_id`,`xml_tag_mandatory`,`xml_tag_description`,`xml_tag_type_code`) VALUES ('actorID[type=local]',0,'actorID[@lido:type="local"]',2);
INSERT INTO `xml_tag` (`xml_tag_id`,`xml_tag_mandatory`,`xml_tag_description`,`xml_tag_type_code`) VALUES ('actorID[source=VIAF]',0,'actorID[@lido:source="VIAF"]',2);
INSERT INTO `xml_tag` (`xml_tag_id`,`xml_tag_mandatory`,`xml_tag_description`,`xml_tag_type_code`) VALUES ('nameActorSet/appellationValue[pref=preferred]',0,'nameActorSet/appellationValue[@lido:pref="preferred"]',2);
