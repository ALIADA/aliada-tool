...
--
-- Servidor: localhost
-- Tiempo de generaciï¿½n: 12-06-2014 a las 12:13:33
-- Versiï¿½n del servidor: 5.0.95
-- Versiï¿½n de PHP: 5.1.6
...
INSERT INTO `aliada`.`organisation` (`organisation_name`, `organisation_path`, `organisation_catalog_url` , `aliada_ontology`, `linking_config_file`, `tmp_dir`, `linking_client_app_bin_dir`, `linking_client_app_user`, `sparql_endpoint_uri`, `sparql_endpoint_login`, `sparql_endpoint_password`, `store_ip`,  `store_sql_port`, `sql_login`, `sql_password`, `isql_command_path`, `isql_commands_file_default`, `public_sparql_endpoint_uri`)
 VALUES ('ARTIUM','/usr/share/tomcat/upload','http://biblioteca.artium.org','http://aliada-project.eu/2014/aliada-ontology/' , '/home/aliada/links-discovery/config/linksdiscoveryTest.properties', '/home/aliada/tmp', '/home/aliada/links-discovery/bin/',
'linking', 'http://localhost:8890/sparql-auth', 'aliada_dev', 'aliada_dev', 'localhost', '1111', 'dba', 'dba', '/home/virtuoso/bin/isql-v', '/home/aliada/linked-data-server/config/isql_id_rewrite_rules_html_default.sql', 'http://localhost:8890/sparql');
...
INSERT INTO aliada.graph (graphId, graph_uri, dataset_base, listening_host, virtual_host, organisationId, isql_commands_file) VALUES (1, 'http://bibdata.artium.org', 'http://aliada-artium.scanbit.net:8890', '*ini*', '*ini*', 1, '/home/aliada/linked-data-server/config/isql_id_rewrite_rules_html_artium.sql');
