...
--$u{rules_suffix}: rulesNamesSuffix, e.g.: dataartiumorgdoclibrary
--$u{uri_doc_concept}: uri_doc_part + dataset.uri_concept_part + subset.uri_concept_part, e.g.: doc/library, collections/library, doc/collections/library
