 ...
 * Class containes "expression" objects which extracts values related with Item entity. 
 *  
 * @author Emiliano Cammilletti
 * @since 1.0
 */
public class ItemDetector extends AbstractEntityDetector<Map<String, List<String>>> { 
	 ...
	 */
	public ItemDetector(final List<Expression<Map<String, List<String>>, Document>> expressions) {
