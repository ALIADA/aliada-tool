 ...
 * @since 1.0
 */
public class RecordDetector extends AbstractEntityDetector<Map<String, List<String>>> { 
	 ...
	 */
	public RecordDetector(final List<Expression<Map<String, List<String>>, Document>> expressions) {
