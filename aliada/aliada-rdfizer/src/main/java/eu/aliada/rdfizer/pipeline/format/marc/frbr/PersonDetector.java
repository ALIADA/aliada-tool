 ...
 * @since 1.0
 */
public class PersonDetector extends AbstractEntityDetector<Map<String, List<String>>> { 
	 ...
	 */
	public PersonDetector(final List<Expression<Map<String, List<String>>, Document>> expressions) {
