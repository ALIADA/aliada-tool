 ...
 * @since 1.0
 */
public class ConceptDetector extends AbstractEntityDetector<Map<String, List<String>>> { 
	 ...
	 */
	public ConceptDetector(final List<Expression<Map<String, List<String>>, Document>> expressions) {
