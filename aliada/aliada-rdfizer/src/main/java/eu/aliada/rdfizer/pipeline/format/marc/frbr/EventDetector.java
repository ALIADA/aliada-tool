 ...
 * @since 1.0
 */
public class EventDetector extends AbstractEntityDetector<Map<String, List<String>>> { 
	 ...
	 */
	public EventDetector(final List<Expression<Map<String, List<String>>, Document>> expressions) {
