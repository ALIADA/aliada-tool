 ...
 * Class containes "expression" objects which extracts values related with Corporate Body entity. 
 *  
 * @author Emiliano Cammilletti
 * @since 1.0
 */
public class CorporateBodyDetector extends AbstractEntityDetector<Map<String, List<String>>> { 
	 ...
	 */
	public CorporateBodyDetector(final List<Expression<Map<String, List<String>>, Document>> expressions) {
